...
function addBox(time, data1, data2, data3, data4) {
	...
	if (data1.Value > 37) { paragraph2.css("background-color", "orange");}
	if (data1.Value > 41) { paragraph2.css("background-color", "red");}
	...
	if (data4.Value > 36) { paragraph5.css("background-color", "orange");}
	if (data4.Value > 41) { paragraph5.css("background-color", "red");}
